...
Imports System.Text
Imports System.IO
Public Class frmQRYEmpUsuarioComercio
    ...
    Protected Sub subFormatoGrid(ByRef GV As GridView, Optional ByVal bExportar As Boolean = False)
        ...
        Else
            ...
            h.DataNavigateUrlFormatString = FORM_MANT_EMP_USUARIO_COMERCIO & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_VER
        ...
        If Not (bExportar) Then
            ...
            h.DataTextField = "IDUSUARIO"
            h.DataNavigateUrlFields = {"IDUSUARIO"}
            h.DataNavigateUrlFormatString = FORM_MANT_EMP_USUARIO_COMERCIO & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_EDITAR
