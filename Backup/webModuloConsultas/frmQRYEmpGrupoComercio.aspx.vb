...
Imports System.Text
Imports System.IO
Public Class frmQRYEmpGrupoComercio
    ...
    Protected Sub subFormatoGrid(ByRef GV As GridView, Optional ByVal bExportar As Boolean = False)
        ...
        h.DataNavigateUrlFormatString = FORM_MANT_EMP_GRUPO_COMERCIO & "?" & PARAM_ID_GRUPO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_VER
        ...
        If Not (bExportar) Then
            ...
            h.DataTextField = "IDGRUPO"
            h.DataNavigateUrlFields = {"IDGRUPO"}
            h.DataNavigateUrlFormatString = FORM_MANT_EMP_GRUPO_COMERCIO & "?" & PARAM_ID_GRUPO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_EDITAR
