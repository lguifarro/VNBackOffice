<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PrincipalVisanet.Master" CodeBehind="frmConsultaVisanet.aspx.vb" Inherits="webModuloConsultas.frmConsultaVisanet" %>
                ...
                <tr>
                    ...
                    <td class="styleCajaFiltro">
                      <table>
                        <tr>
                            <td class="styleLabelFiltro">
                                <asp:Label ID="Label3" runat="server" Text="Empresa" SkinID="labelTextSkin"></asp:Label>
                            </td>
                            <td class="styleCampoFiltro">
                                <asp:DropDownList ID="cmbEmpresa" runat="server" SkinID="DropDownListSkin" Width="120px">
                                </asp:DropDownList>
                        ...
                        <tr>
                            <td class="styleLabelFiltro">
                                <asp:Label ID="Label5" runat="server" Text="Servicio" SkinID="labelTextSkin"></asp:Label>
                            </td>
                            <td class="styleCampoFiltro">
                                <asp:DropDownList ID="cmbServicio" runat="server" SkinID="DropDownListSkin" Width="120px">
                                </asp:DropDownList>
