...
Public Class Principal
    ...
    Public Sub subLoadToolbar(ByVal sURL As String)
        ...
        Select Case sURL
            ...
            Case FORM_QRY_EMP_USUARIO_COMERCIO
                'añade el item
                mIt = New System.Web.UI.WebControls.MenuItem
                mIt.Text = "Nuevo" 'ds.Tables(0).Rows(i)("ITEMTEXTO")
                mIt.ImageUrl = imgNuevo 'ds.Tables(0).Rows(i)("IMAGEURL")
                mIt.NavigateUrl = FORM_MANT_EMP_USUARIO_COMERCIO & "?" & PARAM_OPCION_EDITAR & "=" & OPC_NUEVO '.Tables(0).Rows(i)("URLFORMDESTINO") & ds.Tables(0).Rows(i)("URLQUERYSTRING")
                mIt.ToolTip = "Creacion de un nuevo usuario" 'ds.Tables(0).Rows(i)("TOOLTIP")

                Me.mnuOpc.Items.Add(mIt)

            Case FORM_QRY_EMP_GRUPO_COMERCIO
                'añade el item
                mIt = New System.Web.UI.WebControls.MenuItem
                mIt.Text = "Nuevo" 'ds.Tables(0).Rows(i)("ITEMTEXTO")
                mIt.ImageUrl = imgNuevo 'ds.Tables(0).Rows(i)("IMAGEURL")
                mIt.NavigateUrl = FORM_MANT_EMP_GRUPO_COMERCIO & "?" & PARAM_OPCION_EDITAR & "=" & OPC_NUEVO '.Tables(0).Rows(i)("URLFORMDESTINO") & ds.Tables(0).Rows(i)("URLQUERYSTRING")
                mIt.ToolTip = "Creacion de un nuevo usuario" 'ds.Tables(0).Rows(i)("TOOLTIP")
