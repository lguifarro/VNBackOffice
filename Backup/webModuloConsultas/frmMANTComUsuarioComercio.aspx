<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PrincipalComercio.Master" CodeBehind="frmMANTComUsuarioComercio.aspx.vb" Inherits="webModuloConsultas.frmMANTComUsuarioComercio" %>
...
<table>
        ...
        <tr>
            ...
            <td class="styleCampoFiltro">
                <asp:TextBox ID="txtGrupoComercio" runat="server" SkinID="CajaTextoSkin" Width="200px" MaxLength="30"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="styleLabelFiltro">
