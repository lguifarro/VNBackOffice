...
Public Class frmMANTUsuarioComercio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim sScript As String = FORM_MANT_USUARIO_COMERCIO & "?" & PARAM_ID_USUARIO & "=" & CStr(idUsuarioConsulta) & "&" & PARAM_OPCION_EDITAR & "=" & OPC_RESET_PWD
            Me.bResetPwd.Attributes.Add("onClick", sScript)
    ...
    Protected Sub bCancelar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles bCancelar.Click
