...
Public Class frmTotales
    ...
    Protected Sub subFormatoGrid(ByRef GV As GridView, Optional ByVal bExportar As Boolean = False)
        ...
        For i = 1 To gridTran.Columns.Count - 1
            iAncho = iAncho + gridTran.Columns(i).HeaderStyle.Width.Value
        Next
        GV.Width = iAncho
    ...
    End Sub
    Public Sub subConsulta(Optional ByVal bExportar As Boolean = False)
        ...
        cn = Session(SES_CONN)
        ds = cConsulta.spTotalEmpresa(cn, iIdEmpresa, dFechaINI, dFechaFIN, iIdServicio, sCR)
