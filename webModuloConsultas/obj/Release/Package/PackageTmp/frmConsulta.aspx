<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Principal.Master" CodeBehind="frmConsulta.aspx.vb" Inherits="webModuloConsultas.frmConsulta" %>
                    ...
                    <td class="styleCajaFiltro">
                      <table>
                        ...
                        <tr>
                            ...
                            <td class="styleCampoFiltro">
                                <asp:DropDownList ID="cmbEstado" runat="server" SkinID="DropDownListSkin" Width="120px">
                                </asp:DropDownList>
