...
Imports System.Text
Imports System.IO
Public Class frmQRYComUsuarioComercio
    ...
    Protected Sub subConsultaUsuarioComercio(Optional ByVal bExportar As Boolean = False)
        ...
        cn = Session(SES_CONN)
        ds = cConsulta.spQRYUsuarioComercio(cn, iIdUsuarioBusca, sLoginUsuario, sNombre, sAPaterno, sEmail, iIdGrupoUsuario, 0, iIdUsuario, sCR, sDescError)
    ...
    Protected Sub subFormatoGrid(ByRef GV As GridView, Optional ByVal bExportar As Boolean = False)
        ...
        Else
            ...
            h.DataNavigateUrlFormatString = FORM_MANT_COM_USUARIO_COMERCIO & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_VER
        ...
        If Not (bExportar) Then
            ...
            h.DataTextField = "IDUSUARIO"
            h.DataNavigateUrlFields = {"IDUSUARIO"}
            h.DataNavigateUrlFormatString = FORM_MANT_COM_USUARIO_COMERCIO & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_EDITAR
