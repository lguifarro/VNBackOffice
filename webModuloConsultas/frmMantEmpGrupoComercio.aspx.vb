...
Imports System.Text
Imports System.IO
Public Class frmMantEmpGrupoComercio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Me.lIdEmpresa.Text = CStr(cUsuario.getIdComercio)
        ...
        If Me.bValidaCampos(sResp) Then
            ...
            If VerificaConexion(cn, sDescError) = iResultOK Then
                ...
                If iResp = iResultOK Then
                    ...
                    If sCR = TODO_OK Then
                        Response.Redirect(FORM_QRY_EMP_GRUPO_COMERCIO)
                    Else
