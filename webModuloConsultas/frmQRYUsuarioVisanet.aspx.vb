...
Imports System.Text
Imports System.IO
Public Class frmQRYUsuarioVisanet
    ...
    Protected Sub bConsultar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles bConsultar.Click
        subConsultaUsuario()
    End Sub
    Protected Sub subConsultaUsuario(Optional ByVal bExportar As Boolean = False)
        ...
        cn = Session(SES_CONN)
        ds = cConsulta.spQRYUsuarioVisanet(cn, iIdUsuarioBusca, sLoginUsuario, sNombre, sAPaterno, sEmail, iNIvel, iIdUsuario, sCR, sDescError)
    ...
    Protected Sub subFormatoGrid(ByRef GV As GridView, Optional ByVal bExportar As Boolean = False)
        ...
        Else
            ...
            h.DataNavigateUrlFormatString = FORM_MANT_USUARIO_VISANET & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_VER
        ...
        If Not (bExportar) Then
            ...
            h.DataTextField = "IDUSUARIO"
            h.DataNavigateUrlFields = {"IDUSUARIO"}
            h.DataNavigateUrlFormatString = FORM_MANT_USUARIO_VISANET & "?" & PARAM_ID_USUARIO & "={0}&" & PARAM_OPCION_EDITAR & "=" & OPC_EDITAR
